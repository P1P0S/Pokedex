import { Megaphone, Play, Spinner } from '@phosphor-icons/react'
import { useEffect, useRef, useState } from 'react'

// biome-ignore lint/suspicious/noExplicitAny:
export function PokemonCries({ data }: any) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-white p-3 rounded-md shadow-sm hover:shadow-md transition-shadow">
          <div className="flex items-center justify-between mb-2">
            <span className="font-bold text-sm text-gray-700">Latest Cry</span>
